...
Options:
    ...
    -s, --strength <STRENGTH>  Distortion strength (0=none, 1=normal, >1 stronger) [default: 1.0]
        ...
        --keepbox              Alternative projektion to keep horizontal and vertical
                               lines direct (default is false)

        --expand               Up-scale middle part to avoid artifacts (default is false).
                                The middlepart is zoomed-in causing miltiple pixels getting
                                same color => visible boxes.

        --sharpen              Sharpen middle (default is false). The --expand option may cause
                                blurry images. 
...
The current implemetation contains both AI-generated and manually created code.
